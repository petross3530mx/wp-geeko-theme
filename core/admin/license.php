...
if ( ! class_exists( 'Gecko_Theme_License' ) ) {
    ...
    class Gecko_Theme_License {
        ...
        const THEME_VERSION = '3.0.3.0'; // keep single spaces here, I need them for search.replace - Matt
                    ...
                    <div class="gc-admin__wrapper">
                        <div class="gc-admin__side">
                            ...
                            <div class="gc-admin__menu">
                                ...
                                <a class="new" href="customize.php"><?php esc_html_e( 'Gecko Customizer', 'gecko' ); ?></a>
                            ...
                            <div class="gc-admin__fields">
                                ...
                                <div class="gc-form__row">
                                    ...
                                    <div class="gc-form__controls">
                                        <label class="gc-form__controls-label" for="gecko_license">
                                            <?php
